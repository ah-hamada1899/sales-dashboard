      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md dark:shadow-lg">
            ...
            <p className="text-gray-600 dark:text-gray-400">Switch between bar, line, and pie charts</p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md dark:shadow-lg">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Custom Filtering</h3>
            <p className="text-gray-600 dark:text-gray-400">Set your own sales threshold</p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md dark:shadow-lg">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">API Integration</h3>
            <p className="text-gray-600 dark:text-gray-400">Toggle between mock and API data</p>
          </div>
        </div>
      </div>
    </div>
